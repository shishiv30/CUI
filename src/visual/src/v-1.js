var inital = function() {
    ...
    var go = window.go = function(goIndex, disableScroll) {
        var scropTop = noteHeight * goIndex * -1;
        $container.data('view').scroll(scropTop, disableScroll).then($.throttle(function() {
            updateActive(index);
    ...
    var switchPanel = function() {
        ...
        noteHeight = $('.note-item').outerHeight();
    };
