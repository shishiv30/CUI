...
module.exports = function (grunt) {
    ...
    grunt.registerTask('default', ['copy', 'concat', 'sprite', 'sass', 'autoprefixer', 'cssmin', 'uglify', 'htmlmin','replace','sw-precache']);
    grunt.registerTask('dev', ['copy', 'concat', 'sprite', 'sass', 'autoprefixer', 'sw-precache', 'watch']);
};
